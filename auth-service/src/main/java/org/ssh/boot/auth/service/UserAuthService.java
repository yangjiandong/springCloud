...
public class UserAuthService {
    ...
    public void limitLogin(String userName) {
        // 先取缓存，如果有说明用户被锁
        String key = userName;
        String jsonString = cache.getValue(AppConstants.CACHE_LOGIN_LIMIT, key);
    ...
    void resetFailAttempts(User user) {
        ...
        cache.removeValue(AppConstants.CACHE_LOGIN_LIMIT, user.getUsername());
    }
    ...
    void updateLocked(long lockedAt, User user) {
        ...
        cache.setValue(AppConstants.CACHE_LOGIN_LIMIT, user.getUsername(), JsonMapper.INSTANCE.toJson(user), login_locked_wait_times);
    }
}
