...
public class RecipientControllerTest {
    ...
    public void shouldSaveCurrentRecipientSettings() throws Exception {
        ...
        mockMvc.perform(
            put("/recipients/current").principal(new UserPrincipal(recipient.getAccountName()))
    ...
    public void shouldGetCurrentRecipientSettings() throws Exception {
        ...
        mockMvc.perform(
            get("/recipients/current").principal(new UserPrincipal(recipient.getAccountName())))
