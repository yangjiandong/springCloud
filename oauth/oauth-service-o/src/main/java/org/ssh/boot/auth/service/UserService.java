package org.ssh.boot.auth.service;
...
import org.ssh.boot.AppConstants;
import org.ssh.boot.auth.dao.ResourceDao;
import org.ssh.boot.auth.dao.RoleDao;
import org.ssh.boot.auth.dao.RoleResourceDao;
import org.ssh.boot.auth.dao.UserDao;
import org.ssh.boot.auth.dao.UserRoleDao;
...
import org.ssh.boot.auth.mapper.UserMapper;
...
public class UserService {
  ...
  public void updateFailAttemptsCache(String userName) {
    ...
    // String key = userName;
    String jsonString = cache.getValue(AppConstants.CACHE_LOGIN_LIMIT, userName);
    User user;
    ...
    cache.setValue(AppConstants.CACHE_LOGIN_LIMIT, userName, jsonString, login_locked_wait_times);
  }

  public void resetFailAttemptsCache(String userName) {
    cache.removeValue(AppConstants.CACHE_LOGIN_LIMIT, userName);
  }
  ...
  void updateLockedCache(long lockedAt, User user, String key) {
    ...
    cache.setValue(AppConstants.CACHE_LOGIN_LIMIT, key, jsonString, login_locked_wait_times);
